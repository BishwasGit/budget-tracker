    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <form action="{{ route('goals.store') }}" method="POST" class="space-y-6">
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-md p-4" style="margin-top: 15px;">
                    <div class="flex">
                ...
                <div class="flex justify-between items-center pt-6 border-t border-gray-200" style="margin-top: 24px;">
